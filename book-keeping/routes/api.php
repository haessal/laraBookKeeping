...
use App\Http\Controllers\api\v1\ExportBooksBookIdAccountsAccountGroupIdActionApi;
use App\Http\Controllers\api\v1\ExportBooksBookIdAccountsAccountGroupIdItemsAccountIdActionApi;
use App\Http\Controllers\api\v1\ExportBooksBookIdAccountsAccountGroupIdItemsActionApi;
use App\Http\Controllers\api\v1\ExportBooksBookIdAccountsActionApi;
use App\Http\Controllers\api\v1\ExportBooksBookIdActionApi;
use App\Http\Controllers\api\v1\ExportBooksBookIdSlipsActionApi;
use App\Http\Controllers\api\v1\ExportBooksBookIdSlipsSlipIdActionApi;
use App\Http\Controllers\api\v1\ExportBooksBookIdSlipsSlipIdEntriesActionApi;
use App\Http\Controllers\api\v1\ExportBooksBookIdSlipsSlipIdEntriesSlipEntryIdActionApi;
...
Route::prefix('v1')->group(function () {
    ...
    Route::get('/export/books/{bookId}', ExportBooksBookIdActionApi::class);
    Route::get('/export/books/{bookId}/accounts', ExportBooksBookIdAccountsActionApi::class);
    Route::get('/export/books/{bookId}/accounts/{accountGroupId}', ExportBooksBookIdAccountsAccountGroupIdActionApi::class);
    Route::get('/export/books/{bookId}/accounts/{accountGroupId}/items', ExportBooksBookIdAccountsAccountGroupIdItemsActionApi::class);
    Route::get('/export/books/{bookId}/accounts/{accountGroupId}/items/{accountId}', ExportBooksBookIdAccountsAccountGroupIdItemsAccountIdActionApi::class);
    Route::get('/export/books/{bookId}/slips', ExportBooksBookIdSlipsActionApi::class);
