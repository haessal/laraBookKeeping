...
Route::get('/books/new', [CreateBookActionHtml::class, 'create'])->middleware(['auth', 'verified'])->name('books.create');
Route::post('/books/new', [CreateBookActionHtml::class, 'store'])->middleware(['auth', 'verified'])->name('books.store');
