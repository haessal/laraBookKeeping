...
class Http_Responder_v2_ShowAccountsSettingsViewResponderTest extends TestCase
{
    ...
    public function response_ReturnResponse()
    {
        ...
        $responder = new ShowAccountsSettingsViewResponder($ResponseMock, $ViewFactoryMock);
