...
class Service_BookKeepingServiceTest extends TestCase
{
     ...
     * @test
     */
    public function retrieveSlipEntry_RetrieveTheDefaultBookSlipThatIncludeTheSpecifiedSlipEntry()
    {
        $bookId = (string) Str::uuid();
        $userId = 12;
        $user = new User();
     ...
     * @test
     */
    public function retrieveSlipEntry_RetrieveTheSpecifiedBookSlipThatIncludeTheSpecifiedSlipEntry()
    {
        $bookId = (string) Str::uuid();
        $slipEntryId = (string) Str::uuid();
        $slipId = (string) Str::uuid();
     ...
     * @test
     */
    public function retrieveSlipEntry_SlipNotFound()
    {
        $bookId = (string) Str::uuid();
        $slipEntryId = (string) Str::uuid();
        $accountId_1 = (string) Str::uuid();
     ...
     * @test
     */
    public function updateSlipEntry_UpdateTheSpecifiedSlipEntry()
    {
        $bookId = (string) Str::uuid();
        $slipEntryId = (string) Str::uuid();
