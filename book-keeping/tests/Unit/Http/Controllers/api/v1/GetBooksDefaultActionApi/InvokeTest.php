...
namespace Tests\Unit\Http\Controllers\api\v1\GetBooksDefaultActionApi;
...
class InvokeTest extends TestCase
{
    ...
    public function test_it_returns_internal_server_error_with_unexpected_bookkeeping_service_behavior(): void
    {
        ...
        $serviceMock->shouldReceive('retrieveDefaultBook')
            ->once()
            ->andReturn([-1, null]);
        ...
        $controller = new GetBooksDefaultActionApi($serviceMock, $responderMock);
