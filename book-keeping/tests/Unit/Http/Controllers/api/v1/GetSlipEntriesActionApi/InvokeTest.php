...
namespace Tests\Unit\Http\Controllers\api\v1\GetSlipEntriesActionApi;
...
class InvokeTest extends TestCase
{
    ...
    public function test_it_returns_internal_server_error_with_unexpected_bookkeeping_service_behavior(): void
    {
        ...
        $serviceMock->shouldReceive('retrieveSlips')
            ->once()
            ->with($from, null, null, null, null, null)
            ->andReturn([-1, null]);
        ...
        $controller = new GetSlipEntriesActionApi($serviceMock, $responderMock);
