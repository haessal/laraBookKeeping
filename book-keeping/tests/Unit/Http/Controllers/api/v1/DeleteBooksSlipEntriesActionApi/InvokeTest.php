...
namespace Tests\Unit\Http\Controllers\api\v1\DeleteBooksSlipEntriesActionApi;
...
class InvokeTest extends TestCase
{
    ...
    public function test_it_returns_internal_server_error_with_unexpected_bookkeeping_service_behavior(): void
    {
        ...
        $serviceMock->shouldReceive('validateUuid')
            ...
            ->with($slipEntryId)
            ->andReturn(true);
        $serviceMock->shouldReceive('deleteSlipEntryAndEmptySlip')
            ->once()
        ...
        $controller = new DeleteBooksSlipEntriesActionApi($serviceMock, $responderMock);
