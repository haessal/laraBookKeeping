...
namespace Tests\Unit\Http\Controllers\page\v2\ShowAccountsSettingsActionHtml;
...
class InvokeTest extends TestCase
{
    ...
    public function test_it_returns_internal_server_error_with_unexpected_bookkeeping_service_behavior_1(): void
    {
        ...
        /** @var \App\Http\Responder\page\v2\ShowAccountsSettingsViewResponder|\Mockery\MockInterface $responderMock */
        ...
        $controller = new ShowAccountsSettingsActionHtml($serviceMock, $responderMock);
        try {
