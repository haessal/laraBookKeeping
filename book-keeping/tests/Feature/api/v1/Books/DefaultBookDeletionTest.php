...
class DefaultBookDeletionTest extends TestCase
{
    ...
    public function test_book_can_be_updated(): void
    {
        $response = $this->actingAs($this->user)
            ->delete('/api/v1/books/'.$this->book->book_id.'/default');
    ...
    {
        $response = $this->actingAs($this->user)
            ->delete('/api/v1/books/'.$this->sharedBook->book_id.'/default');
    ...
    {
        $response = $this->actingAs($this->user)
            ->delete('/api/v1/books/'.$this->unavailableBook->book_id.'/default');
