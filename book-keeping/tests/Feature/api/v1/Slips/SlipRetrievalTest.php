...
class SlipRetrievalTest extends TestCase
{
    ...
    public function test_specified_slip_of_specified_book_can_be_retrieved(): void
    {
        $response = $this->actingAs($this->user)
            ->get('/api/v1/books/'.$this->book->book_id.'/slips/'.$this->slip->slip_id);
    ...
    public function test_slip_is_not_retrieved_with_invalid_path_parameter_for_book_id(): void
    {
        $response = $this->actingAs($this->user)
            ->get('/api/v1/books/0/slips/'.$this->slip->slip_id);
    ...
    {
        $response = $this->actingAs($this->user)
            ->get('/api/v1/books/'.$this->book->book_id.'/slips/0');
    ...
    {
        $response = $this->actingAs($this->user)
            ->get('/api/v1/books/'.$this->unavailableBook->book_id.'/slips/'.$this->slip->slip_id);
    ...
    {
        $response = $this->actingAs($this->user)
            ->get('/api/v1/books/'.$this->book->book_id.'slips/'.$this->unavailableSlip->slip_id);
