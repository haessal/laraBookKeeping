...
class DefaultBookSlipEntryRetrievalTest extends TestCase
{
    ...
    public function test_specified_slip_entry_of_default_book_can_be_retrieved(): void
    {
        $response = $this->actingAs($this->user)
            ->get('/api/v1/slipentries/'.$this->slipEntry->slip_entry_id);
    ...
    {
        $response = $this->actingAs($this->user)
            ->get('/api/v1/slipentries/'.$this->unavailableSlipEntry->slip_entry_id);
