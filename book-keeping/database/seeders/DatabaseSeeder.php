...
class DatabaseSeeder extends Seeder
{
     ...
     * @return array
     */
    private function createUser(int $count): array
    {
     ...
     * @return array
     */
    private function createBook(int $count): array
    {
     ...
     * @return void
     */
    private function createBookContents(string $bookId)
    {
     ...
     * @return array
     */
    private function createAccount(string $bookId): array
    {
     ...
     * @return void
     */
    private function createBudget(string $bookId, array $accountIds)
    {
     ...
     * @return array
     */
    private function createSlip(string $bookId, array $accountIds): array
    {
