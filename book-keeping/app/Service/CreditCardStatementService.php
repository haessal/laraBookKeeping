...
class CreditCardStatementService
{
    ...
    public function retrieveCreditCardStatements($bookId, $creditCardStatementId)
    {
        ...
        foreach ($creditCardStatementList as $creditCardStatementItem) {
            $creditCardStatements[$creditCardStatementItem['credit_card_statement_id']] = [
                'credit_card_statement_id' => $creditCardStatementItem['credit_card_statement_id'],
                'credit_card_statement_outline' => $creditCardStatementItem['credit_card_statement_outline'],
                'credit_card_statement_memo' => $creditCardStatementItem['credit_card_statement_memo'],
