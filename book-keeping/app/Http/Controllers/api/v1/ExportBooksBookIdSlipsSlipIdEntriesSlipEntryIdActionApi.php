...
class ExportBooksBookIdSlipsSlipIdEntriesSlipEntryIdActionApi extends AuthenticatedBookKeepingMigrationActionApi
{
    /**
    ...
    public function __invoke(Request $request, string $bookId, string $slipId, string $slipEntryId): JsonResponse
    {
        ...
        [$status, $books] = $this->BookKeeping->exportSlipEntry($bookId, $slipId, $slipEntryId);
        switch ($status) {
