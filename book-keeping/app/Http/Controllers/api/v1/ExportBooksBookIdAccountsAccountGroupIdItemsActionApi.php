...
class ExportBooksBookIdAccountsAccountGroupIdItemsActionApi extends AuthenticatedBookKeepingMigrationActionApi
{
    /**
     ...
     */
    public function __invoke(Request $request, string $bookId, string $accountGroupId): JsonResponse
    {
        $context = [];
        $response = null;
        ...
        [$status, $books] = $this->BookKeeping->exportAccountItems($bookId, $accountGroupId);
        switch ($status) {
