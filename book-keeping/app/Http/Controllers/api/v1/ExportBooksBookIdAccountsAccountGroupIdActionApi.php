...
class ExportBooksBookIdAccountsAccountGroupIdActionApi extends AuthenticatedBookKeepingMigrationActionApi
{
    /**
    ...
    public function __invoke(Request $request, string $bookId, string $accountGroupId): JsonResponse
    {
        ...
        [$status, $books] = $this->BookKeeping->exportAccountGroup($bookId, $accountGroupId);
        switch ($status) {
