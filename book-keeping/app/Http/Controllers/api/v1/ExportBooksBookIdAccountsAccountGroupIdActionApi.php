...
class ExportBooksBookIdAccountsAccountGroupIdActionApi extends AuthenticatedBookKeepingActionApi
{
    /**
    ...
    public function __invoke(Request $request, string $bookId, string $accountGroupId): JsonResponse
    {
        ...
        $context['books'] = $this->BookKeeping->exportAccountGroup($bookId, $accountGroupId);
