...
class ExportBooksBookIdSlipsSlipIdEntriesActionApi extends AuthenticatedBookKeepingActionApi
{
    /**
    ...
    public function __invoke(Request $request, string $bookId, string $slipId): JsonResponse
    {
        ...
        $context['books'] = $this->BookKeeping->exportSlipEntries($bookId, $slipId);
