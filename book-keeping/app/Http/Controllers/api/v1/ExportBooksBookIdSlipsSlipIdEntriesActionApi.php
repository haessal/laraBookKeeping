...
class ExportBooksBookIdSlipsSlipIdEntriesActionApi extends AuthenticatedBookKeepingMigrationActionApi
{
    /**
    ...
    public function __invoke(Request $request, string $bookId, string $slipId): JsonResponse
    {
        ...
        [$status, $books] = $this->BookKeeping->exportSlipEntries($bookId, $slipId);
        switch ($status) {
